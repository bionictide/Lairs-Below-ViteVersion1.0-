    ...
    _create_class(EncounterManager, [
        ...
        },
        {
            ...
            value: function handleAttack(initiatorId, targetId) {
                // Only emit the attack request to the server
                this.socket.emit('requestAttack', { initiatorId, targetId });
                // Optionally, show a UI prompt that the attack was requested
                this.scene.events.emit('showActionPrompt', 'Attack requested. Waiting for server...');
            }
        },
        {
            ...
            value: function handleSteal(initiatorId, targetId) {
                // Only emit the steal request to the server
                this.socket.emit('requestSteal', { initiatorId, targetId });
                // Optionally, show a UI prompt that the steal was requested
                this.scene.events.emit('showActionPrompt', 'Steal attempt requested. Waiting for server...');
            }
        },
        {
            key: "handleTrade",
